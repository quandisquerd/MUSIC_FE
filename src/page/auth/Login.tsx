...
import { CustomerServiceOutlined, LoadingOutlined, SelectOutlined } from "@ant-design/icons";
      ...
      <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
        <div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
          <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            <div className="flex items-center w-32 mx-auto font-bold text-orange-500 text-2xl ">
            ...
            <div className="mt-12 flex flex-col items-center">
              <h1 className="text-2xl xl:text-3xl font-extrabold">Signin</h1>
                  ...
                  >
                    {loginLoading ? (
                      ...
                      <div className="flex items-center">
                        ...
                        <SelectOutlined className="font-bold text-sm"/>
                        <span className="ml-1">Sign In</span>
                      </div>
                    )}
                  </button>
                  <p className="mt-6 text-xs text-gray-600 text-center">
                    I agree to abide by KETAMIN's
                    <a
                      href="#"
                    ...
                    <Link to="/register" className="ml-2 text-blue-400">sign up</Link>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex-1 bg-black text-center hidden lg:flex">
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://res.cloudinary.com/daqolzo0n/image/upload/v1741836975/b8f47569-bc44-4cbb-ba5f-f5163b2272ac_a5ydna.jpg')",
              }}
            ></div>
          </div>
        </div>
